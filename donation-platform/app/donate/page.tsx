...
//   // Handle adding new donation item
//   const handleAddItem = () => {
//     if (!currentItem.category || !currentItem.quantity) {
//       toast({
//         title: "Missing information",
...
//             setCurrentItem(prev => ({
//               ...prev,
//               images: [...prev.images, { url: cloudinaryUrl, analysis }]
//             }))
...
//     const result = await model.generateContent([
//       "Analyze this donation item image and describe its condition in 2-3 sentences.",
//       {
//         inlineData: {
//           data: base64Image.split(",")[1],
//           mimeType: "image/jpeg"
...
//           toast({
//             title: "Location error",
//             description: "Couldn't fetch address from coordinates",
//             variant: "destructive",
//           })
//         }
//       },
...
//                             {image.analysis && (
//                               <div className="w-full p-2 bg-gray-100 rounded-lg">
//                                 <p className="text-sm text-gray-700">{image.analysis}</p>
//                               </div>
//                             )}
//                           </div>
//                         ))}
...
//                           {isUploadingImage ? (
//                             <>
//                               <Progress value={uploadProgress} className="w-[80%] mb-1" />
...
//                   <div className="flex items-center space-x-2">
//                     <RadioGroupItem value="scheduled" id="scheduled" />
//                     <Label htmlFor="scheduled">Schedule a specific time</Label>
//                   </div>
//                   <div className="flex items-center space-x-2">
//                     <RadioGroupItem value="asap" id="asap" />
//                     <Label htmlFor="asap">As soon as possible</Label>
...
//                 <div className="pt-4">
//                   <p className="text-sm text-muted-foreground">
//                     The NGO will confirm the exact pickup time after reviewing your donation.
//                   </p>
//                 </div>
//               </div>
...
//                   />
//                   <p className="text-sm text-muted-foreground">
//                     Please include building number, street, city, and postal code.
//                   </p>
//                 </div>
//               </div>
...
//                           1
//                         </div>
//                         <p>Your donation request will be sent to {ngoData?.name}</p>
//                       </li>
//                       <li className="flex items-start gap-2">
//                         <div className="flex h-5 w-5 items-center justify-center rounded-full bg-primary/10 text-primary text-xs">
//                           2
//                         </div>
//                         <p>They'll review your items within 24 hours</p>
//                       </li>
//                       <li className="flex items-start gap-2">
//                         <div className="flex h-5 w-5 items-center justify-center rounded-full bg-primary/10 text-primary text-xs">
//                           3
//                         </div>
//                         <p>You'll receive email confirmation when scheduled</p>
//                       </li>
//                     </ol>
//                   </div>
//                 </div>
