        ...
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Fill in the details about your donation and we'll connect you with nearby NGOs
            </p>
          </div>
              ...
              {[
                ...
                return (
                  <li key={i} className="flex flex-col items-center">
                    ...
                    <span
                      className={`mt-2 text-xs ${isActive || isCompleted ? "font-medium" : "text-muted-foreground"}`}
                    >
                      {s.title}
                    </span>
                  </li>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
                    {categories.map((category) => (
                      <Card
                        key={category.id}
                        className={`text-center cursor-pointer hover:border-primary transition-colors ${currentItem.category === category.id ? "border-primary bg-primary/5" : ""
                          }`}
